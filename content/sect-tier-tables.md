...
| B | Caitiff | Most Caitiff default to Anarch by circumstance; no clan weakness, no Discipline ceiling from clan identity, no elder lineage to serve; the Anarch context is the only one that doesn't structurally disadvantage them; natural rank-and-file. |
