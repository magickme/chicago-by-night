...
| Baptism by Fire (LATENT — NYE 1990) | Chicago views Gary as 'stable but fragile' (per Horace). Coterie signal system COMPLETED (S025). BbF room selection for Allicia privacy window in progress (Darius). |
| ~~Marcus Webb~~ | ARCHIVED. 14/14 conditioned. |
| ~~Warehouse + customs gap~~ | ARCHIVED. |
| ~~Sal Cantone~~ | ARCHIVED. RICO closed. |
...
| ~~Warren Birch proxy~~ | ARCHIVED. Webb operational. |
| ~~Church disposal~~ | ARCHIVED. |
...
| COTERIE with Sable | ACTIVE. Fri Dec 7 call completed (S025). Signal system delivered. Received: Milwaukee contact/15-min window, Dane 5-night data, Halloran trace. Working: BbF room selection for privacy window. Next call: Tue Dec 11. |
...
| ~~Mystery Obfuscate visitor~~ | ARCHIVED. Was Horace Turnbull (D026). |
