...
<dt>Claimed By</dt><dd>Khalid al-Rashid</dd>
...
- Ublo-Satha dwells in the deepest reaches, and no one talks about what that means for the structural integrity of the network. The deeper you go, the less the architecture follows human logic.
...
- **Network Extent:** The usable tunnel system runs from the Loop north to the Gold Coast and south to Printer's Row. East-west coverage reaches from the lakefront to Halsted. Not all of it is occupied — much of it is buffer zone and early warning perimeter.
