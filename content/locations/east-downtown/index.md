...
<img class="character-portrait" src="cover.webp" alt="East Downtown">
...
- N Lincoln Memorial Dr runs the length of the lakefront — a single arterial connecting Turk's marina to Scott's neighborhood to Badr's UWM-adjacent condo.

## Function in Play

Where the gang war happens. East Downtown is the feeding ground, the combat zone, and the place the Primogen Council pretends does not exist. Bars, clubs, live venues, and the violence that follows them. Akawa's Blood Brothers hold the east blocks, Turk's Union holds the area around the marina. The border between them shifts nightly.
