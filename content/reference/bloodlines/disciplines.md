...
**Requires:** Prior Sense the Sin or equivalent knowledge of the target's flaw
**Pool:** Wits + Intimidation, difficulty = target's Courage + 4
...
### ●●● Conflagration
**Cost:** 1+ blood points (each = 1 die aggravated damage)
**Pool:** Dexterity + Occult (difficulty 6) to hit; target may dodge
...
### ●●●● Psychomachia
**Requires:** Knowledge of target's tragic flaw
**Pool:** Target rolls their lowest Virtue (difficulty 6)
