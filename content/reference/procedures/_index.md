...
The core principle: **canonical state lives in files, not in memory**. Session-state.md is authoritative. The boot packet is derived. If they diverge, regenerate the boot packet.
