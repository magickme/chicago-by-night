---
title: "Overview"
description: "What this reference is, how it is organized, and how to use it. A guide to the V20 SRD structure."
weight: 5
---
...
### [Character Creation](/reference/character-creation/)
...
**For quick access:** See the [Disciplines index](/reference/disciplines/) for the Clan Disciplines table showing which clans have which powers.

### [V20 Mechanics](/reference/v20/)

The complete rules system. Follows V20's Systems and Drama chapter order:

| Topic | What it covers |
|-------|---------------|
| [Core Dice](/reference/v20/core-dice/) | Dice pools, difficulty, success/failure/botch, extended and contested rolls |
| [Blood Economy](/reference/v20/blood-economy/) | Nightly blood cost, spending, vessel yields, feeding, Self-Control cap |
| [Generation](/reference/v20/generation/) | Generation chart, blood pool maximums, trait caps, social implications |
| [Virtues](/reference/v20/virtues/) | Conscience/Conviction, Self-Control/Instinct, Courage |
| [Combat](/reference/v20/combat/) | Three-stage combat: initiative, attack, damage/soak |
| [Health & Healing](/reference/v20/health/) | Health levels, damage types, torpor, fire, sunlight |
| [Frenzy & Rötschreck](/reference/v20/frenzy/) | Beast triggers, resistance rolls, riding the wave |
| [Hunting & Feeding](/reference/v20/hunting/) | Hunting methods, area difficulties, the Kiss |
| [Blood Bond](/reference/v20/blood-bond/) | Formation, stages, Vinculum, breaking free |
| [Humanity & Degeneration](/reference/v20/humanity/) | Hierarchy of Sin, degeneration rolls, recovery |
| [Paths of Enlightenment](/reference/v20/paths/) | All 11 Paths with Hierarchies of Sin |
...
| [Thin-Blooded](/reference/character-creation/bloodlines/thin-blooded/) | 14th–16th Generation, Dhampirs, Seer Merit, Blood Rot |
