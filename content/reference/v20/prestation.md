...
| | Camarilla | Anarch |
|--|-----------|--------|
| Recording | Public, Harpy-tracked | Informal, personal |
| Currency | Favor for favor (no money equivalent) | Money accepted as direct equivalent |
| Timing | Debts accumulate indefinitely | Immediate exchange preferred |
| Enforcement | Prince arbitration | Community social pressure only |
| Involuntary bonds | Blood bonds can be used as leverage | Explicitly rejected — freedom of association is core |
