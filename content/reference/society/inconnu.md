...
| Name | Clan | Notes |
|------|------|-------|
| Saulot | Salubri | Believed Inconnu before Tremere diablerized him; may persist within Tremere |
| Kemintiri | Followers of Set | Elder double agent — sometimes claimed as Inconnu, sometimes as active Setite |
| Various ancients | Mixed | The Inner Circle's composition is speculation; several 4th-generation vampires are rumored |
...
- Inconnu Monitors have observed Golconda seekers across centuries
- The inner circle may include Kindred who have achieved it
- A Monitor who judges a vampire genuinely ready may point them toward resources, but will not provide a roadmap

For Golconda mechanics and prerequisites, see [Golconda](/reference/v20/golconda/).
