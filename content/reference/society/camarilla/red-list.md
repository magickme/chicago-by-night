...
1. **Destroy an Anathema** — automatic appointment upon confirmed Final Death and presentation of evidence
2. **Dual nomination** — two Justicars jointly nominate a candidate; the candidate is reviewed on: Generation (lower preferred), Clan (Ventrue, Nosferatu, Gangrel favored), sire relationship, prior rank (Archons preferred but not required), region, and proposed role/task
