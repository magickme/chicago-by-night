...
Published adventure check: When a Fate Question or Random Event touches a PUBLISHED adventure, consult the adventure's Tracker file (`Overview/Acts/<Adventure> - Tracker.md` — scene checklist + divergence ledger, the position authority) and the published source structure before narrating. Adding to published material is fine; contradicting it or a ledgered divergence breaks continuity. Scene Check is SUSPENDED for scenes executing a published beat (interstitial scenes still roll). Emergent deviations get a divergence-ledger row the scene they happen (/end-scene does this).
...
|---|---|
|1-3|Lodin (3x)|
|4-5|Ballard (2x) — CONTAINED (Ballard's Case resolved S044)|
...
|30|Tomás Navarro (NOW PC)|
|31|Drummond (TURNED S035, delivered Primogen S035, intel delivered S044)|
|32|Walt Gryzinski|
|33|Tamoszius|
|34|Lucina (Milwaukee)|
|35|Sophia Ayes|
...
|39|Brennon Thornhill|
|40|Raymond Falcon|
|41|Craig Hessler|
|42|Martin Hayward|
|43|Sabbat Scout (unnamed, Toreador antitribu?)|
|44|Tyrus (Wolf Pack leader, Gangrel)|
|45|Killikillarven (Critias associate, 9th gen?)|
|46|Dimitri (DEAD: diablerized by Critias D045)|
|47|Gordon Keaton (Caitiff, Gold Coast/Loop — confirmed D057 as Nicolai's independent contractor, picked up staked Ehrich for chantry transport)|
|48|Rolf (DEPARTED — Dimitri's operative, ordered out of Chicago D045)|
|49|Darva Felispa (DEPARTED — Lure operative, ordered out of Chicago D045)|
|50|Deborah Stanford (Vault employee, Forgetful Mind D043)|
|51|Paulov Rasporavitch (DEPARTED — Dimitri's operative, ordered out of Chicago D045)|
|52|Malcolm (Gangrel, Succubus Club — D045 first contact, Grabowski line)|
|53|Mrs. Elridge (Lodin's office staff, phone contact — NEW D047)|
|54|Son / Jason Newberry (Malkavian 8th, Skokie — D052 first contact, intel broker, tunnels/Pedway/Nosferatu)|
|55|Dennis Herdon (mortal fence, North Clark New Town — ENTRANCED by Sable 5 succ, expires Feb 12. Conditioning target 0/14. Coterie asset.)|
|56|Warren Sayles (mortal hunter, ex-Jesuit, Society of Leopold field — Mesmerized + Forgetful Mind'd + post-hypnotic: recall Dane. Settebello D053.)|
|57|Alberto Tomba (mortal hunter, ex-Jesuit, Society of Leopold field/forgery — Mesmerized + Forgetful Mind'd + post-hypnotic: handle Dane personally. Settebello D053.)|
|58|Fr. Emil Koenig (mortal, Jesuit, Loyola — Society of Leopold researcher, Chicago cell. NOT contacted by coterie.)|
|59|Margaret Weil (mortal, lay Archdiocese employee — Society of Leopold logistics, Chicago cell. NOT contacted by coterie.)|
|60|Paula Magnus (mortal, occult investigator — posing as IRS, asking about Annabelle's Pilsen real estate. Identified D053 during Darius hunt. Reported to Annabelle + Neally. Not engaged.)|
|61|Michael (DEAD: Malkavian 8th, Gary, Telton Cemetery — killed by Bach's Sabbat pack, scorched skull found Pilsen rooftop D053. Dane's hunt drove him from Gary.)|
|62|Ehrich (Tremere rogue, ~100+ years old — D057 captured at Succubus Club during Grand Elusion. Interrogated by Tomás. Bond-breaking method (unrepeatable, Sabbat-assisted, 4-year process). Delivered staked to Keaton for Tremere chantry transport. In chantry custody.)|
|63|Orloff (mortal Magus, 26yo, telekinetic — D057 detained at Succubus Club. Armed with telekinetic knife. Mesmerized by Tomás. Interrogated. Thief of silver chalice (motivation unknown). Held at Club pending disposition.)|
|64|Gibson (mortal Magus, 82yo, senile — D057 extracted clean through Brennon's back corridor. Ehrich's old friend. Sabbat contact status unknown. Departed Club.)|
|65|Karl (mortal, Anarch teamster leader — D057 stood down after Darius's Command during Grand Elusion. Departed scene.)|
...
|d10|Prompt|
|---|---|
|1|I see the whole board. I freeze because I see the whole board.|
|2|Nicolai left the samples on the counter. He knew before I left.|
|3|She botched her own Presence and laughed about it. Nobody in the Pyramid laughs about failure.|
|4|The Sheriff earned his badge by staking his own sire. This city runs on betrayal.|
|5|I filed the report and they promoted me for keeping quiet. The Pyramid does the same thing with better paperwork.|
|6|El Paso is 1,700 miles away. My mother lights a candle every Sunday for a dead man who isn't dead.|
|7|Cole runs Dominate 4 from a 12th-gen cover. He's better at this than anyone in this chantry except Nicolai.|
|8|The tamales smell like Ochoa Street. I eat one in front of Mrs. Marsh because the alternative is worse.|
|9|A Toreador I can't read, a Ventrue who lies about his generation, and a Tremere who freezes. Three analysts. Three blind spots.|
|10|Something new.|
